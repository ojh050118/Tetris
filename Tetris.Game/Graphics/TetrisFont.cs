...
namespace Tetris.Game.Graphics
{
    ...
    public static class TetrisFontExtensions
    {
        ...
        {
            string familyString = typeface != null ? TetrisFont.GetFamilyString(typeface.Value) : usage.Family;
            string weightString = weight != null ? TetrisFont.GetWeightString(familyString, weight.Value) : usage.Weight;
